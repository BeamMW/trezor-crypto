...
SRCS  += memzero.c
SRCS  += beam/nonce_generator.c beam/definitions.c beam/definitions_lut.c beam/internal.c beam/functions.c beam/lib/scalar32.c beam/lib/field_impl.c beam/lib/field_10x26_impl.c beam/lib/group_impl.c beam/lib/util.c beam/lib/vec.c
